...
SELECT p.id, p.created_at, p.updated_at, title, p.url, description, published_at, p.feed_id, f.id, f.created_at, f.updated_at, name, f.url, f.user_id, last_feched_at, ff.id, ff.created_at, ff.updated_at, ff.user_id, ff.feed_id FROM posts AS p
